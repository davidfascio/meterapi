...
${OBJECTDIR}/KitronMeterHandler.o: KitronMeterHandler.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/KitronMeterHandler.o KitronMeterHandler.c

${OBJECTDIR}/KitronMeterInterface.o: KitronMeterInterface.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/KitronMeterInterface.o KitronMeterInterface.c
