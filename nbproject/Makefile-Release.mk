...
${OBJECTDIR}/KitronMeterInterface.o: KitronMeterInterface.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/KitronMeterInterface.o KitronMeterInterface.c
...
${OBJECTDIR}/MeterControl.o: MeterControl.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MeterControl.o MeterControl.c
...
${OBJECTDIR}/Meters_Table.o: Meters_Table.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Meters_Table.o Meters_Table.c

${OBJECTDIR}/ScorpioMeterInterface.o: ScorpioMeterInterface.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ScorpioMeterInterface.o ScorpioMeterInterface.c
...
${OBJECTDIR}/SystemQueue.o: SystemQueue.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SystemQueue.o SystemQueue.c
