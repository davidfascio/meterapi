...
int main(int argc, char** argv) {
    ...
    */
    ...
    //API_SCORPIO_Recieve_handler(meter_adding_answer, sizeof(meter_adding_answer), &meterDescriptor, &commandCallback );
...
BYTE command[] = {Dis_MTR,Con_MTR,Dis_MTR, Con_MTR};
